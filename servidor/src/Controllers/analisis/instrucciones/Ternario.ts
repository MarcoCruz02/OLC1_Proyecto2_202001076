...
export default class Ternario extends Instruccion {
    ...
    constructor(cond: Instruccion, expT: Instruccion, expF: Instruccion, linea: number, columna: number) {
            ...
            if (condt == true) {
                ...
                switch (obtTipo) {
                    ...
                    case tipoDato.VOID:
                        ...
                        return expTt
                    default:
                        return new Errores("Semantico", "Ternario V Declaracion R tipo de respuesta no coincide con los tipos", this.linea, this.columna)
                }
            //si la condicion del ternario no es verdadera
                ...
                switch (obtTipo) {
                    ...
                    case tipoDato.VOID:
                        ...
                        return expFt
                    default:
                        return new Errores("Semantico", "Ternario F Declaracion R tipo de respuesta no coincide con los tipos", this.linea, this.columna)
                }
            }
            ...
            if (condt == true) {
                ...
                switch (obtTipo) {
                    ...
                    case tipoDato.VOID:
                        ...
                        return expTt
                    default:
                        return new Errores("Semantico", "Ternario V Declaracion L tipo de respuesta no coincide con los tipos", this.linea, this.columna)
                }
            //si es logica y falsa
                ...
                switch (obtTipo) {
                    ...
                    case tipoDato.VOID:
                        ...
                        return expFt
                    default:
                        return new Errores("Semantico", "Ternario F Declaracion L tipo de respuesta no coincide con los tipos", this.linea, this.columna)
                }
            }
